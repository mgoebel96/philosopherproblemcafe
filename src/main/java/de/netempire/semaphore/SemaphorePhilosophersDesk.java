package de.netempire.semaphore;

import de.netempire.semaphore.classes.Fork;
import de.netempire.semaphore.classes.Philosopher;
import de.netempire.semaphore.logger.ResultLogger;
...
public class SemaphorePhilosophersDesk {
    ...
    public static void main(String[] args) {
        SemaphorePhilosophersDesk.startProcess();
    }
